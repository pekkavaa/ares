...
auto RSP::Recompiler::emit(u12 address) -> Block* {
  ...
  while(true) {
    ...
    if(callInstructionPrologue) {
      ...
      call_args(&RSP::instructionPrologue, imm(instruction));
    }
    pipeline.begin();
    ...
    if(!pipeline.singleIssue && !branched && u12(address + 4) != start) {
      ...
      if(RSP::canDualIssue(op0, op1)) {
        ...
        call_args(&RSP::instructionEpilogue<1>, imm(0));
        if(callInstructionPrologue) {
          // mov32(reg(1), imm(instruction));
          // call(&RSP::instructionPrologue);
          call_args(&RSP::instructionPrologue, imm(instruction));
    ...
    // call(&RSP::instructionEpilogue<1>);
    call_args(&RSP::instructionEpilogue<1>, imm(pipeline.clocks));
    address += 4;
    if(hasBranched || address == start) break;
    hasBranched = branched;
    testJumpEpilog();
...
#define call_args_vu(name,...) \
  switch(E) { \
  case 0x0: call_args(name<0x0>, __VA_ARGS__); break; \
  case 0x1: call_args(name<0x1>, __VA_ARGS__); break; \
  case 0x2: call_args(name<0x2>, __VA_ARGS__); break; \
  case 0x3: call_args(name<0x3>, __VA_ARGS__); break; \
  case 0x4: call_args(name<0x4>, __VA_ARGS__); break; \
  case 0x5: call_args(name<0x5>, __VA_ARGS__); break; \
  case 0x6: call_args(name<0x6>, __VA_ARGS__); break; \
  case 0x7: call_args(name<0x7>, __VA_ARGS__); break; \
  case 0x8: call_args(name<0x8>, __VA_ARGS__); break; \
  case 0x9: call_args(name<0x9>, __VA_ARGS__); break; \
  case 0xa: call_args(name<0xa>, __VA_ARGS__); break; \
  case 0xb: call_args(name<0xb>, __VA_ARGS__); break; \
  case 0xc: call_args(name<0xc>, __VA_ARGS__); break; \
  case 0xd: call_args(name<0xd>, __VA_ARGS__); break; \
  case 0xe: call_args(name<0xe>, __VA_ARGS__); break; \
  case 0xf: call_args(name<0xf>, __VA_ARGS__); break; \
  }
...
auto RSP::Recompiler::emitEXECUTE(u32 instruction) -> bool {
  ...
  case 0x04: {
    ...
    // mov32(reg(3), imm(i16));
    // call(&RSP::BEQ);
    call_args(&RSP::BEQ, mem(Rs), mem(Rt), imm(i16));
    return 1;
  }
  ...
  case 0x05: {
    ...
    // mov32(reg(3), imm(i16));
    // call(&RSP::BNE);
    call_args(&RSP::BNE, mem(Rs), mem(Rt), imm(i16));
    return 1;
  }
  ...
  case 0x06: {
    ...
    // mov32(reg(2), imm(i16));
    // call(&RSP::BLEZ);
    call_args(&RSP::BLEZ, mem(Rs), imm(i16));
    return 1;
  }
  ...
  case 0x07: {
    ...
    // mov32(reg(2), imm(i16));
    // call(&RSP::BGTZ);
    call_args(&RSP::BGTZ, mem(Rs), imm(i16));
    return 1;
  }
  ...
  case 0x20: {
    ...
    // mov32(reg(3), imm(i16));
    // call(&RSP::LB);
    call_args(&RSP::LB, mem(Rt), mem(Rs), imm(i16));
    return 0;
  }
  ...
  case 0x21: {
    ...
    // mov32(reg(3), imm(i16));
    // call(&RSP::LH);
    call_args(&RSP::LH, mem(Rt), mem(Rs), imm(i16));
    return 0;
  }
  ...
  case 0x23: {
    ...
    // mov32(reg(3), imm(i16));
    // call(&RSP::LW);
    call_args(&RSP::LW, mem(Rt), mem(Rs), imm(i16));
    return 0;
  }
  ...
  case 0x24: {
    ...
    // mov32(reg(3), imm(i16));
    // call(&RSP::LBU);
    call_args(&RSP::LBU, mem(Rt), mem(Rs), imm(i16));
    return 0;
  }
  ...
  case 0x25: {
    ...
    // mov32(reg(3), imm(i16));
    // call(&RSP::LHU);
    call_args(&RSP::LHU, mem(Rt), mem(Rs), imm(i16));
    return 0;
  }
  ...
  case 0x27: {
    ...
    // mov32(reg(3), imm(i16));
    // call(&RSP::LWU);
    call_args(&RSP::LWU, mem(Rt), mem(Rs), imm(i16));
    return 0;
  }
  ...
  case 0x28: {
    ...
    // mov32(reg(3), imm(i16));
    // call(&RSP::SB);
    call_args(&RSP::SB, mem(Rt), mem(Rs), imm(i16));
    return 0;
  }
  ...
  case 0x29: {
    ...
    // mov32(reg(3), imm(i16));
    // call(&RSP::SH);
    call_args(&RSP::SH, mem(Rt), mem(Rs), imm(i16));
    return 0;
  }
  ...
  case 0x2b: {
    ...
    // mov32(reg(3), imm(i16));
    // call(&RSP::SW);
    call_args(&RSP::SW, mem(Rt), mem(Rs), imm(i16));
    return 0;
  }
...
auto RSP::Recompiler::emitSPECIAL(u32 instruction) -> bool {
  ...
  case 0x09: {
    ...
    // lea(reg(2), Rs);
    // call(&RSP::JALR);
    call_args(&RSP::JALR, mem(Rd), mem(Rs));
    return 1;
  }
...
auto RSP::Recompiler::emitREGIMM(u32 instruction) -> bool {
  ...
  case 0x00: {
    ...
    // mov32(reg(2), imm(i16));
    // call(&RSP::BLTZ);
    call_args(&RSP::BLTZ, mem(Rs), imm(i16));
    return 1;
  }
  ...
  case 0x01: {
    ...
    // mov32(reg(2), imm(i16));
    // call(&RSP::BGEZ);
    call_args(&RSP::BGEZ, mem(Rs), imm(i16));
    return 1;
  }
  ...
  case 0x10: {
    ...
    // mov32(reg(2), imm(i16));
    // call(&RSP::BLTZAL);
    call_args(&RSP::BLTZAL, mem(Rs), imm(i16));
    return 1;
  }
  ...
  case 0x11: {
    ...
    // mov32(reg(2), imm(i16));
    // call(&RSP::BGEZAL);
    call_args(&RSP::BGEZAL, mem(Rs), imm(i16));
    return 1;
  }
...
auto RSP::Recompiler::emitSCC(u32 instruction) -> bool {
  ...
  case 0x00: {
    ...
    // mov32(reg(2), imm(Rdn));
    // call(&RSP::MFC0);
    call_args(&RSP::MFC0, mem(Rt), imm(Rdn));
    return 0;
  }
  ...
  case 0x04: {
    ...
    // mov32(reg(2), imm(Rdn));
    // call(&RSP::MTC0);
    call_args(&RSP::MTC0, mem(Rt), imm(Rdn));
    return 0;
  }
...
auto RSP::Recompiler::emitVU(u32 instruction) -> bool {
  ...
  case 0x00: {
    ...
    // lea(reg(2), Vs);
    // callvu(&RSP::MFC2);
    call_args_vu(&RSP::MFC2, mem(Rt), mem(Vs));
    return 0;
  }
  ...
  case 0x02: {
    ...
    // mov32(reg(2), imm(Rdn));
    // call(&RSP::CFC2);
    call_args(&RSP::CFC2, mem(Rt), imm(Rdn));
    return 0;
  }
  ...
  case 0x04: {
    ...
    // lea(reg(2), Vs);
    // callvu(&RSP::MTC2);
    call_args_vu(&RSP::MTC2, mem(Rt), mem(Vs));
    return 0;
  }
  ...
  case 0x06: {
    ...
    // mov32(reg(2), imm(Rdn));
    // call(&RSP::CTC2);
    call_args(&RSP::CTC2, mem(Rt), imm(Rdn));
    return 0;
  }
  ...
  case 0x00: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VMULF);
    call_args_vu(&RSP::VMULF, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x01: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VMULU);
    call_args_vu(&RSP::VMULU, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x02: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VRNDP);
    call_args_vu(&RSP::VRNDP, mem(Vd), imm(Vsn), mem(Vt));
    return 0;
  }

  //VMULQ Vd,Vs,Vt(e)
  case 0x03: {
    call_args_vu(&RSP::VMULQ, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }

  //VMUDL Vd,Vs,Vt(e)
  case 0x04: {
    call_args_vu(&RSP::VMUDL, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }

  //VMUDM Vd,Vs,Vt(e)
  case 0x05: {
    call_args_vu(&RSP::VMUDM, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }

  //VMUDN Vd,Vs,Vt(e)
  case 0x06: {
    call_args_vu(&RSP::VMUDN, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }

  //VMUDH Vd,Vs,Vt(e)
  case 0x07: {
    call_args_vu(&RSP::VMUDH, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }

  //VMACF Vd,Vs,Vt(e)
  case 0x08: {
    call_args_vu(&RSP::VMACF, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }

  //VMACU Vd,Vs,Vt(e)
  case 0x09: {
    call_args_vu(&RSP::VMACU, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }

  //VRNDN Vd,Vs,Vt(e)
  case 0x0a: {
    call_args_vu(&RSP::VRNDN, mem(Vd), imm(Vsn), mem(Vt));
    return 0;
  }
  ...
  case 0x0c: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VMADL);
    call_args_vu(&RSP::VMADL, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x0d: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VMADM);
    call_args_vu(&RSP::VMADM, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x0e: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VMADN);
    call_args_vu(&RSP::VMADN, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x0f: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VMADH);
    call_args_vu(&RSP::VMADH, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x10: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VADD);
    call_args_vu(&RSP::VADD, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x11: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VSUB);
    call_args_vu(&RSP::VSUB, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x12: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VZERO);
    call_args_vu(&RSP::VZERO, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x13: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VABS);
    call_args_vu(&RSP::VABS, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x14: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VADDC);
    call_args_vu(&RSP::VADDC, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x15: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VSUBC);
    call_args_vu(&RSP::VSUBC, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x1d: {
    ...
    // lea(reg(2), Vs);
    // callvu(&RSP::VSAR);
    call_args_vu(&RSP::VSAR, mem(Vd), mem(Vs));
    return 0;
  }
  ...
  case 0x20: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VLT);
    call_args_vu(&RSP::VLT, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x21: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VEQ);
    call_args_vu(&RSP::VEQ, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x22: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VNE);
    call_args_vu(&RSP::VNE, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x23: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VGE);
    call_args_vu(&RSP::VGE, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x24: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VCL);
    call_args_vu(&RSP::VCL, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x25: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VCH);
    call_args_vu(&RSP::VCH, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x26: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VCR);
    call_args_vu(&RSP::VCR, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x27: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VMRG);
    call_args_vu(&RSP::VMRG, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x28: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VAND);
    call_args_vu(&RSP::VAND, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x29: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VNAND);
    call_args_vu(&RSP::VNAND, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x2a: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VOR);
    call_args_vu(&RSP::VOR, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x2b: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VNOR);
    call_args_vu(&RSP::VNOR, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x2c: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VXOR);
    call_args_vu(&RSP::VXOR, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x2d: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VNXOR);
    call_args_vu(&RSP::VNXOR, mem(Vd), mem(Vs), mem(Vt));
    return 0;
  }
  ...
  case 0x30: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VRCP);
    call_args_vu(&RSP::VRCP, mem(Vd), imm(DE), mem(Vt));
    return 0;
  }
  ...
  case 0x31: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VRCPL);
    call_args_vu(&RSP::VRCPL, mem(Vd), imm(DE), mem(Vt));
    return 0;
  }
  ...
  case 0x32: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VRCPH);
    call_args_vu(&RSP::VRCPH, mem(Vd), imm(DE), mem(Vt));
    return 0;
  }
  ...
  case 0x33: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VMOV);
    call_args_vu(&RSP::VMOV, mem(Vd), imm(DE), mem(Vt));
    return 0;
  }
  ...
  case 0x34: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VRSQ);
    call_args_vu(&RSP::VRSQ, mem(Vd), imm(DE), mem(Vt));
    return 0;
  }
  ...
  case 0x35: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VRSQL);
    call_args_vu(&RSP::VRSQL, mem(Vd), imm(DE), mem(Vt));
    return 0;
  }
  ...
  case 0x36: {
    ...
    // lea(reg(3), Vt);
    // callvu(&RSP::VRSQH);
    call_args_vu(&RSP::VRSQH, mem(Vd), imm(DE), mem(Vt));
    return 0;
  }
...
auto RSP::Recompiler::emitLWC2(u32 instruction) -> bool {
  ...
  case 0x00: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::LBV);
    call_args_vu(&RSP::LBV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x01: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::LSV);
    call_args_vu(&RSP::LSV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x02: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::LLV);
    call_args_vu(&RSP::LLV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x03: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::LDV);
    call_args_vu(&RSP::LDV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x04: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::LQV);
    call_args_vu(&RSP::LQV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x05: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::LRV);
    call_args_vu(&RSP::LRV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x06: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::LPV);
    call_args_vu(&RSP::LPV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x07: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::LUV);
    call_args_vu(&RSP::LUV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x08: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::LHV);
    call_args_vu(&RSP::LHV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x09: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::LFV);
    call_args_vu(&RSP::LFV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x0b: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::LTV);
    call_args_vu(&RSP::LTV, imm(Vtn), mem(Rs), imm(i7));
    return 0;
  }
...
auto RSP::Recompiler::emitSWC2(u32 instruction) -> bool {
  ...
  case 0x00: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::SBV);
    call_args_vu(&RSP::SBV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x01: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::SSV);
    call_args_vu(&RSP::SSV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x02: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::SLV);
    call_args_vu(&RSP::SLV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x03: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::SDV);
    call_args_vu(&RSP::SDV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x04: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::SQV);
    call_args_vu(&RSP::SQV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x05: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::SRV);
    call_args_vu(&RSP::SRV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x06: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::SPV);
    call_args_vu(&RSP::SPV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x07: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::SUV);
    call_args_vu(&RSP::SUV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x08: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::SHV);
    call_args_vu(&RSP::SHV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x09: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::SFV);
    call_args_vu(&RSP::SFV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x0a: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::SWV);
    call_args_vu(&RSP::SWV, mem(Vt), mem(Rs), imm(i7));
    return 0;
  }
  ...
  case 0x0b: {
    ...
    // mov32(reg(3), imm(i7));
    // callvu(&RSP::STV);
    call_args_vu(&RSP::STV, imm(Vtn), mem(Rs), imm(i7));
    return 0;
  }
